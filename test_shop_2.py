...
async def main():
    async with async_playwright() as p:
        ...
        # Open Home Design menu instead
        await page.evaluate("""() => {
            window.document.getElementById('homeCustomizationModal').style.display = 'flex';
        }""")

        await page.wait_for_timeout(1000)

        await page.screenshot(path="verification_home_customization.png")
        print("Done!")
        await browser.close()
