...
window.createTypeIconTexture = function(scene, type) {
    let textureKey = 'type_icon_' + type;
    ...
    if (type === 'Fire') {
        ...
        // Unknown type - draw a question mark
...
if (!content.includes('window.createTypeIconTexture = function')) {
    content = content.replace('window.getItemIconHTML = function', iconFunc + '\nwindow.getItemIconHTML = function');
    fs.writeFileSync('index.html', content);
    console.log("Injected window.createTypeIconTexture");
} else {
