...
- Name: tests/dualBattle.spec.js >> Cooperative Dual Battle Event >> should successfully roll and trigger Dual Battle event
- Location: tests/dualBattle.spec.js:17:3
