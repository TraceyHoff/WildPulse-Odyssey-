...
- Name: tests/shopAndInventory.spec.js >> Shop and Inventory Systems >> should use items and apply their effects correctly
- Location: tests/shopAndInventory.spec.js:98:3
