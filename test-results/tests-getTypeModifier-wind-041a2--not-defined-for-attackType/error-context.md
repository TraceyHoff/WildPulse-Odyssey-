...
- Name: tests/getTypeModifier.spec.js >> window.getTypeModifier >> returns 1 when defenseType is not defined for attackType
- Location: tests/getTypeModifier.spec.js:14:3
