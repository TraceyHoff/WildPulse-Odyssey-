...
// Insert after storage_chest texture creation
const insertTarget = "scene.textures.addCanvas('storage_chest', scCanvas);";
const replacementStr = insertTarget + `
    ...
    window.add3DDepth(couchCtx, 0, 0, 100, 100);
    ...
    window.add3DDepth(deskCtx, 0, 0, 100, 100);
