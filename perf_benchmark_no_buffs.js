...
// Setup global variables to zero so innerText update is skipped sometimes
window.p1RepellentTime = 0;
window.p1JankJuiceTime = 0;
window.p1ExPallTime = 0;
window.p1PedometerTime = 0;
window.p1NpcDualTime = 0;
window.p1WildDualTime = 0;

window.p2RepellentTime = 0;
window.p2JankJuiceTime = 0;
window.p2ExPallTime = 0;
window.p2PedometerTime = 0;
window.p2NpcDualTime = 0;
window.p2WildDualTime = 0;
